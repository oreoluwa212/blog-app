...
import design from '../assets/images/abstractDesign.svg';
...
const Header = () => {
  ...
  // };
  return (
    <div className='container mx-auto border-accent border-b-[0.1px] border-opacity-15'>
    <div className=' flex border-accent border-b-[0.1px] border-opacity-15'>
      ...
      <div className="border-accent  border-l-[0.1px] border-b-[0.1px] w-[65%]  border-opacity-15">
        <img src={design} alt="design" className='absolute h-80'/>
