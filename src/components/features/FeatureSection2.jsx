...
const FeatureSection2 = ({ icon, features, linkTo, linkText, className }) => {
   return (
      <div className='w-full'>
         <div className=''>
            <div className='relative flex flex-col lg:flex-row items-center py-10 lg:px-[5%] px-5 border-y-2 border-opacity-15 border-accent'>
            ...
            <div className='flex lg:flex-row flex-col justify-between py-16 bg-secondary lg:px-[5%] px-5 lg:pr-10'>
               <div className=''>
                  <button className='bg-background text-white/90 text-sm p-2'>
                     A Knowledge Treasure Trove
                  </button>
                  <h1 className='lg:text-4xl text-3xl pt-2'>
                     Explore FutureTech&apos;s In-Depth Blog Resources
                  </h1>
               </div>
